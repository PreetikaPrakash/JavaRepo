public class thread_states implements Runnable {
    ...
    // Reference variable of Thread class and thread_states class is created.
    ...
    public void run() {
        ...
        try
        {
            ...
            // calls thread 1 how ? it calls based on the object, current class is thread_states so its object is only called
            // acc to line 11, 12
            Thread.sleep(200);
        }
...
class ABC implements Runnable
{
    ...
    public void run()
    {
        ...
        System.out.println("The state of thread t1 while it invoked the method join() on thread t2 -"+ thread_states.t1.getState());
