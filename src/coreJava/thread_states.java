...
public class thread_states implements Runnable {
    ...
    // Reference variable of Thread class and coreJava.thread_states class is created.
    ...
    public void run() {
        ...
        try
        {
            ...
            // calls thread 1 how ? it calls based on the object, current class is coreJava.thread_states so its object is only called
            // acc to line 11, 12
            Thread.sleep(200);
        }
